...
(function (DropDown) {
    ...
    WinJS.UI.processAll().done(function () {
        ...
        Binding.Collection.Select.Refresh(["pSelect"], GetPlayersByTeamsId(dataBindingListInternal.group.team.id), function () {
            return;
        });
    ...
    function GetTeamsByGroupId(groupId) {
        return $.grep(teams, function (e) {
            return e.groupId == groupId;
        });
    }

    function GetPlayersByTeamsId(teamId) {
        return $.grep(players, function (e) {
...
var TestTeam = (function () {
    function TestTeam(id, t, i, b, g) {
        this.id = id;
        this.title = t;
        this.image = i;
        this.backColor = b;
...
var objGroup = (function () {
    function objGroup(i, title, team) {
        this.id = i;
        this.title = title;
        this.team = team;
    }
